...
def plot_yahoo_equity_line():
    real_data = EquityRealTimeDAO().get_min_time_and_price(datetime.datetime(2018, 1, 19, 9, 30, 0))
    min_data = EquityMinDAO().get_time_and_price(datetime.datetime(2018, 1, 19, 9, 30, 0))
